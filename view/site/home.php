                ...
                <div class="row align-items-center mb--20">
                    <div class="col-lg-6 mb-20">
                        <div class="search-ticket-header">
                            <h6 class="category">welcome to Booking-2 </h6>
                    ...
                    <div class="col-lg-6 mb-20">
                        <ul class="tab-menu ticket-tab-menu">
                            <li class="active">
                                <div class="tab-thumb">
                                    <img src="<?php echo $this->assets;?>images/ticket/ticket-tab01.png" alt="ticket">
                                </div>
                                <span>movie</span>
                            </li>
                            <li>
                                <div class="tab-thumb">
                                    <img src="<?php echo $this->assets;?>images/ticket/ticket-tab02.png" alt="ticket">
                                </div>
                                <span>events</span>
                            </li>
                            <li>
                                <div class="tab-thumb">
                                    <img src="<?php echo $this->assets;?>images/ticket/ticket-tab03.png" alt="ticket">
                                </div>
                                <span>sports</span>
                            </li>
                        </ul>
                    ...
                    <div class="tab-item active">
                        <form class="ticket-search-form">
                            ...
                            <div class="form-group">
                                <div class="thumb">
                                    <img src="<?php echo $this->assets;?>images/ticket/city.png" alt="ticket">
                                </div>
                            ...
                            <div class="form-group">
                                <div class="thumb">
                                    <img src="<?php echo $this->assets;?>images/ticket/date.png" alt="ticket">
                                </div>
                            ...
                            <div class="form-group">
                                <div class="thumb">
                                    <img src="<?php echo $this->assets;?>images/ticket/cinema.png" alt="ticket">
                                </div>
            ...
            <div class="row flex-wrap-reverse justify-content-center">
                <div class="col-lg-3 col-sm-10  mt-50 mt-lg-0">
                    <div class="widget-1 widget-facility">
                        <div class="widget-1-body">
                            <ul>
                                <li>
                                    <a href="#0">
                                        <span class="img"><img src="<?php echo $this->assets;?>images/sidebar/icons/sidebar01.png" alt="sidebar"></span>
                                        <span class="cate">24X7 Care</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#0">
                                        <span class="img"><img src="<?php echo $this->assets;?>images/sidebar/icons/sidebar02.png" alt="sidebar"></span>
                                        <span class="cate">100% Assurance</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#0">
                                        <span class="img"><img src="<?php echo $this->assets;?>images/sidebar/icons/sidebar03.png" alt="sidebar"></span>
                    ...
                    <div class="widget-1 widget-banner">
                        <div class="widget-1-body">
                            <a href="#0">
                                <!-- <img src="<?php echo $this->assets;?>images/sidebar/banner/banner01.jpg" alt="banner"> -->
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="widget-1 widget-banner">
                        <div class="widget-1-body">
                            <a href="#0">
                                <!-- <img src="<?php echo $this->assets;?>images/sidebar/banner/banner02.jpg" alt="banner"> -->
                            </a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row mb-30-none justify-content-center">
                            <div class="col-sm-6 col-lg-4">
                                <div class="event-grid">
                                    <div class="movie-thumb c-thumb">
                                        <a href="#0">
                                            <img src="<?php echo $this->assets;?>images/event/event01.jpg" alt="event">
                                        </a>
                            ...
                            <div class="col-sm-6 col-lg-4">
                                <div class="event-grid">
                                    <div class="movie-thumb c-thumb">
                                        <a href="#0">
                                            <img src="<?php echo $this->assets;?>images/event/event02.jpg" alt="event">
                                        </a>
                                        <div class="event-date">
                                            <h6 class="date-title">28</h6>
                                            <span>Dec</span>
                            ...
                            <div class="col-sm-6 col-lg-4">
                                <div class="event-grid">
                                    <div class="movie-thumb c-thumb">
                                        <a href="#0">
                                            <img src="<?php echo $this->assets;?>images/event/event03.jpg" alt="event">
                                        </a>
                                        <div class="event-date">
                                            <h6 class="date-title">28</h6>
                                            <span>Dec</span>
                        ...
                        <div class="row mb-30-none justify-content-center">
                            <div class="col-sm-6 col-lg-4">
                                <div class="sports-grid">
                                    <div class="movie-thumb c-thumb">
                                        <a href="#0">
                                            <img src="<?php echo $this->assets;?>images/sports/sports01.jpg" alt="sports">
                                        </a>
                                        <div class="event-date">
                                            <h6 class="date-title">28</h6>
                                            <span>Dec</span>
                            ...
                            <div class="col-sm-6 col-lg-4">
                                <div class="sports-grid">
                                    <div class="movie-thumb c-thumb">
                                        <a href="#0">
                                            <img src="<?php echo $this->assets;?>images/sports/sports02.jpg" alt="sports">
                                        </a>
                                        <div class="event-date">
                                            <h6 class="date-title">28</h6>
                                            <span>Dec</span>
                            ...
                            <div class="col-sm-6 col-lg-4">
                                <div class="sports-grid">
                                    <div class="movie-thumb c-thumb">
                                        <a href="#0">
                                            <img src="<?php echo $this->assets;?>images/sports/sports03.jpg" alt="sports">
                                        </a>
                                        <div class="event-date">
                                            <h6 class="date-title">28</h6>
                                            <span>Dec</span>
